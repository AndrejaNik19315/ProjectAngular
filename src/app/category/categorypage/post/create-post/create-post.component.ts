  ...
  tryPost(values){
    ...
    if(this.postForm.valid){
      ...
      .then(res => {
        ...
        post.innerHTML = "<div class='card-body'><a href='"+this.route.snapshot.params.name+"/"+res.parent.id+"'><h3 class='card-title'>"+values.postTitle+"</h3></a><p class='card-text mt-2'>"+values.postDescription+"</p></hr><div class='pl-2 pr-2 text-muted'>Posted on Just now <a href='user/FzKApeUg31Vf4MhkdOMdQAjyJsI2'>Username</a></div></div>";
